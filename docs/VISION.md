...
```
Listen → Log → Resurface → Reflect → Share → Repeat
```
...
- **Repeat**: habit reinforces over time as the data gets richer
...
3. **Grounded** — triggered by patterns: "I've been through transitions before and I survived"
4. **Seen** — triggered by interpretation: "the app noticed something true about me"
5. **Shocked** — triggered by time distortion: "I haven't logged that artist in 3 years"

This arc is the product north star. Features that contribute to it are worth building. Features that don't, aren't.
...
These must feel free. Habit formation requires zero friction on the core loop.

Charge for:
- **Era clustering** — seeing your life organized into chapters
- **Pattern insights** — what the data reveals about you
- **Shareable era/moment cards** — beautiful exports
- **Unlimited photos** — storage-heavy, emotionally valuable
- **Yearly recap** — the Wrapped moment
- **AI narrative summaries** — the interpretation layer
...
**Soft in tone. Sharp in insight.**

The app speaks gently — but it notices things precisely. Examples:

| Too soft | Too sharp | Right |
|----------|-----------|-------|
| "This song feels special." | "63% of entries logged after 10pm." | "Most of your moments happen after 10pm. Night might be your truest hour." |
| "Here's a memory." | "Mood distribution: 40% reflective." | "You tend toward reflection this time of year." |

The language should feel like a thoughtful friend who has read everything you've written — not a therapist, not an algorithm.
...
That's the product. Everything else is in service of that.
